...
<p align="left">
  Я студент Высшей Школы Экономики по программе "Бизнес-информатика" с 2022 года и стремлюсь стать Frontend разработчиком. Имею базовые знания в HTML, CSS и JavaScript. Уверенно владею программами Adobe: Photoshop, Premiere, Lightroom, After Effects, Illustrator, а также Figma. Владею базовыми знаниями C# и Python. Умею работать в системе контроля версий GitHub. Знаком с PostgreSQL, PgAdmin и DBeaver. Также умею работать со звуком в Ableton. В течение последних пяти лет занимаюсь фото- и видеосъемкой на любительском уровне. Имею базовые умения работы на фреймворках Django и ASP.NET.
</p>
